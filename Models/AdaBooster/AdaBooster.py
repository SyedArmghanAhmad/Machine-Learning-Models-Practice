...
plt.savefig(f"{output_folder}/Scatter Plots of Features vs Price.jpg", format='jpg', dpi=300, bbox_inches='tight')
plt.show()
...
# Initialize & Train the AdaBoost Regressor
...
plt.savefig(f"{output_folder}/Actual Vs Predicted House Prices with AdaBoost.jpg",format='jpg', dpi=300, bbox_inches='tight')
plt.show()
